...
def generate_launch_description():
    ...
    slam_toolbox_launch_cmd = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'slam_params_file': '/home/vortex/uas_nav/src/UAS-DTU-navigation-simulation/lirovo/config/slam_params' , #os.path.join(pkg_bcr, 'config', 'mapper_params_online_async.yaml'), meine hataya custom params lene ke liye
        }.items()
    )
