...
def generate_launch_description():
    ...
    nav2_launch_cmd = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'params_file': '/home/vortex/uas_nav/src/UAS-DTU-navigation-simulation/lirovo/config/nav2_params.yaml' , #os.path.join(pkg_bcr, 'config', 'nav2_params.yaml'),
    ...
    #amcl_node = Node( meine comment out kiya kyunki ham amcl use nhi karte
    #    package='nav2_amcl',
    #    executable='amcl',
    #    name='amcl',
    #    output='screen',
