...
protected:
  ...
  // Uncomment the block below to restore stock parameter declarations:
  // =========================================================================
  /*
  ...
  */
  ...
  // =========================================================================
  // [MODULAR NARROW FOV OPTIMIZATIONS - NEW PARAMETER DECLARATIONS]
  // - enable_heading_scan_intake_: Change 1 (In-place spin scan intake)
  // - enable_synchronized_intake_thresholds_: Change 5 (1.0x Karto threshold sync)
  // - enable_heading_radian_units_: Change 6 (Heading units degrees-to-radians fix)
  // =========================================================================
  bool first_measurement_, enable_interactive_mode_;
  bool restamp_tf_;
  bool enable_heading_scan_intake_;
  bool enable_synchronized_intake_thresholds_;
  bool enable_heading_radian_units_;
